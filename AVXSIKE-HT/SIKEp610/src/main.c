...
void test_sidh()
{
  __m512i skA[SECRETKEY_A_BYTES] = { 0 }, pkA[6*NWORDS]; 
  __m512i skB[SECRETKEY_B_BYTES] = { 0 }, pkB[6*NWORDS];
...
void timing_sidh()
{
  __m512i skA[SECRETKEY_A_BYTES], pkA[6*NWORDS]; 
  __m512i skB[SECRETKEY_B_BYTES], pkB[6*NWORDS];
  __m512i ssA[2*NWORDS], ssB[2*NWORDS];
