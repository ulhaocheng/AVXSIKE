...
void get_3_isog(const point_proj_t P, f2elm_t A24minus, f2elm_t A24plus, f2elm_t* coeff)
{
  ...
  mp2_add(t4, t0, t3);                            // t4 = 4*X^2 - (X+Z)^2 + (X-Z)^2 
  mp2_add(t4, t4, t4);                            // t4 = 2(4*X^2 - (X+Z)^2 + (X-Z)^2) 
  mp2_add(t4, t1, t4);                            // t4 = 8*X^2 - (X+Z)^2 + 2*(X-Z)^2
  fp2mul_mont(A24minus, t2, t4);                  // A24minus = [4*X^2 - (X-Z)^2]*[8*X^2 - (X+Z)^2 + 2*(X-Z)^2]
  mp2_add(t4, t1, t2);                            // t4 = 4*X^2 + (X+Z)^2 - (X-Z)^2
  mp2_add(t4, t4, t4);                            // t4 = 2(4*X^2 + (X+Z)^2 - (X-Z)^2) 
  mp2_add(t4, t0, t4);                            // t4 = 8*X^2 + 2*(X+Z)^2 - (X-Z)^2
