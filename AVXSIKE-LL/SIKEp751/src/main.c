...
void test_fp()
{
  ...
  a_4x2w[i] = VSET(0, 0, 0, 0, 0, 0, 0, a51[i]);
  b_4x2w[i] = VSET(0, 0, 0, 0, 0, 0, 0, b51[i]);
  ...
  mpi_print("* 8x1w MONT MUL R: 0x", r64, NWORDS_FIELD);
  ...
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2w MONT MUL R: 0x", r64, NWORDS_FIELD);
...
void test_fpx()
{
  ...
  a_2x2x2w[i] = VSET(0, 0, 0, 0, 0, b51[i], 0, a51[i]);
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1w FPX MUL R[0]: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, r_8x1x1w[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1w FPX MUL R[1]: 0x", r64, NWORDS_FIELD);
  ...
  get_channel_8x1w(r51, r_8x1x1w[0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1w FPX SQR R[0]: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, r_8x1x1w[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1w FPX SQR R[1]: 0x", r64, NWORDS_FIELD);
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1w FPX MUL R[0]: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, r_4x2x1w, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1w FPX MUL R[1]: 0x", r64, NWORDS_FIELD);
  ...
  get_channel_8x1w(r51, r_4x2x1w, 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1w FPX SQR R[0]: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, r_4x2x1w, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1w FPX SQR R[1]: 0x", r64, NWORDS_FIELD);
  ...
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2w FPX MUL R[0]: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, r_2x2x2w, 2);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2w FPX MUL R[1]: 0x", r64, NWORDS_FIELD);
  ...
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2w FPX SQR R[0]: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, r_2x2x2w, 2);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2w FPX SQR R[1]: 0x", r64, NWORDS_FIELD);
...
void test_curve()
{
  ...
  uint64_t mont_Rx4[VNWORDS] = {
    0x00000000124D6, 0x0000000000000, 0x0000000000000, 0x0000000000000, 
    0x0000000000000, 0x0000000000000, 0x0000000000000, 0x553943DC70000, 
    0x0A39C8A2434C0, 0x440D32D95346F, 0x0A03506906D4A, 0x78BAE7027B43B, 
    0x66D227E903B49, 0x4FE1F0A230C0C, 0x00013A81F3FDB, };

  uint64_t mont_Rx6[VNWORDS] = {
    0x000000001B73E, 0x0000000000000, 0x0000000000000, 0x0000000000000, 
    0x0000000000000, 0x0000000000000, 0x0000000000000, 0x748AE330B0000, 
    0x25A1694F9DEFE, 0x05956EE274B93, 0x4152D9CE78982, 0x5DC912B279ACE, 
    0x4AD06F6DADADF, 0x62582FE984FA1, 0x00071688ED142, };
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w XP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_8x1x1x1w.X[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w XP1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_8x1x1x1w.Z[0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w ZP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_8x1x1x1w.Z[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w ZP1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_8x1x1x1w.X[0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w XQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_8x1x1x1w.X[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w XQ1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_8x1x1x1w.Z[0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w ZQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_8x1x1x1w.Z[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w ZQ1: 0x", r64, NWORDS_FIELD);
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w XP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, x3z3x2z2, 3);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w XP1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, x3z3x2z2, 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w ZP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, x3z3x2z2, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w ZP1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, x3z3x2z2, 6);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w XQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, x3z3x2z2, 7);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w XQ1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, x3z3x2z2, 4);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w ZQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, x3z3x2z2, 5);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x4x2x1w ZQ1: 0x", r64, NWORDS_FIELD);
  ...
  for (i = 0; i < VNWORDS; i++) {
    ...
    C24_A1_2x2x2x1w[i] = VSET(0, mont_Rx4[i], 0, vmont_R[i], 0, mont_Rx4[i], 0, vmont_R[i]);
  }
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w XQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_2x2x2x1w, 3);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w XQ1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_2x2x2x1w, 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w ZQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_2x2x2x1w, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w ZQ1: 0x", r64, NWORDS_FIELD);
  ...
  for (i = 0; i < VGWORDS-1; i++) {
    ...
    Q_1x2x2x2w[i]      = VZERO;
    C24_A1_1x2x2x2w[i] = VSET(0, 0, mont_Rx4[i+VGWORDS], mont_Rx4[i], 0, 0, vmont_R[i+VGWORDS], vmont_R[i]);
  } 
  P_1x2x2x2w[i]      = VSET(0, xP1[i], 0, xP0[i], 0, zP1[i], 0, zP0[i]);
  Q_1x2x2x2w[i]      = VZERO;
  C24_A1_1x2x2x2w[i] = VSET(0, 0, 0, mont_Rx4[i], 0, 0, 0, vmont_R[i]);
  ...
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w XQ0: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, Q_1x2x2x2w, 6);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w XQ1: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, Q_1x2x2x2w, 0);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w ZQ0: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, Q_1x2x2x2w, 2);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w ZQ1: 0x", r64, NWORDS_FIELD);
  ...
  for (i = 0; i < VGWORDS-1; i++) {
    P_1x2x2x2w[i]      = VSET(xP1[i+VGWORDS], xP1[i], xP0[i+VGWORDS], xP0[i], zP1[i+VGWORDS], zP1[i], zP0[i+VGWORDS], zP0[i]);
    Q_1x2x2x2w[i]      = VZERO;
    C24_A1_1x2x2x2w[i] = VSET(0, 0, mont_Rx4[i+VGWORDS], mont_Rx4[i], 0, 0, mont_Rx6[i+VGWORDS], mont_Rx6[i]);
  } 
  P_1x2x2x2w[i]      = VSET(0, xP1[i], 0, xP0[i], 0, zP1[i], 0, zP0[i]);
  Q_1x2x2x2w[i]      = VZERO;
  C24_A1_1x2x2x2w[i] = VSET(0, 0, 0, mont_Rx4[i], 0, 0, 0, mont_Rx6[i]);
...
void test_isog()
{
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w A24+   0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, A24plus_8x1x1x1w[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w A24+   1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, C24_8x1x1x1w[0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w C24    0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, C24_8x1x1x1w[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w C24    1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff_8x1x1x1w[0][0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w COEFF 00: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff_8x1x1x1w[0][1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w COEFF 01: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff_8x1x1x1w[1][0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w COEFF 10: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff_8x1x1x1w[1][1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w COEFF 11: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff_8x1x1x1w[2][0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w COEFF 20: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff_8x1x1x1w[2][1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 8x1x1x1w COEFF 21: 0x", r64, NWORDS_FIELD);
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w A24+   0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, C24_A24plus_2x2x2x1w, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w A24+   1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, C24_A24plus_2x2x2x1w, 2);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w C24    0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, C24_A24plus_2x2x2x1w, 3);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w C24    1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff__0_2x2x2x1w, 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w COEFF 00: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff__0_2x2x2x1w, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w COEFF 01: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff2_1_2x2x2x1w, 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w COEFF 10: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff2_1_2x2x2x1w, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w COEFF 11: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff2_1_2x2x2x1w, 2);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w COEFF 20: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, coeff2_1_2x2x2x1w, 3);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w COEFF 21: 0x", r64, NWORDS_FIELD);
  ...
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w A24+   0: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, C24_A24plus_1x2x2x2w, 2);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w A24+   1: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, C24_A24plus_1x2x2x2w, 4);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w C24    0: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, C24_A24plus_1x2x2x2w, 6);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w C24    1: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, coeff__0_1x2x2x2w, 0);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w COEFF 00: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, coeff__0_1x2x2x2w, 2);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w COEFF 01: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, coeff2_1_1x2x2x2w, 0);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w COEFF 10: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, coeff2_1_1x2x2x2w, 2);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w COEFF 11: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, coeff2_1_1x2x2x2w, 4);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w COEFF 20: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, coeff2_1_1x2x2x2w, 6);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w COEFF 21: 0x", r64, NWORDS_FIELD);
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w XP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_4x2x1x1w[1], 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w XP1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_4x2x1x1w[0], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w ZP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_4x2x1x1w[1], 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w ZP1: 0x", r64, NWORDS_FIELD);
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w XP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_2x2x2x1w, 3);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w XP1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_2x2x2x1w, 0);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w ZP0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, P_2x2x2x1w, 1);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 2x2x2x1w ZP1: 0x", r64, NWORDS_FIELD);
  ...
  P_1x2x2x2w[i] = VSET(0, xP1[i], 0, xP0[i], 0, zP1[i], 0, zP0[i]);
  coeff_1x2x2x2w[0][i] = VSET(0, 0, 0, 0, 0, xP1[i], 0, xP0[i]);
  coeff_1x2x2x2w[1][i] = VSET(0, zP1[i], 0, zP0[i], 0, 0, 0, 0);
  coeff_1x2x2x2w[2][i] = VSET(0, yP1[i], 0, yP0[i], 0, 0, 0, 0);
  ...
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w XP0: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, P_1x2x2x2w, 6);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w XP1: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, P_1x2x2x2w, 0);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w ZP0: 0x", r64, NWORDS_FIELD);
  get_channel_4x2w(r51, P_1x2x2x2w, 2);
  carryp(r51);
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 1x2x2x2w ZP1: 0x", r64, NWORDS_FIELD);
  ...
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w XQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_4x2x1x1w[1], 1); 
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w XQ1: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_4x2x1x1w[0], 0); 
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w ZQ0: 0x", r64, NWORDS_FIELD);
  get_channel_8x1w(r51, Q_4x2x1x1w[1], 0); 
  mpi_conv_51to64(r64, r51, NWORDS_FIELD, VNWORDS);
  mpi_print("* 4x2x1x1w ZQ1: 0x", r64, NWORDS_FIELD);
  ...
  Q_1x2x2x2w[i] = VSET(0, xP1[i], 0, xP0[i], 0, zP1[i], 0, zP0[i]);
  coeff0_1_1x2x2x2w[i] = VSET(0, yP1[i], 0, yP0[i], 0, xP1[i], 0, xP0[i]);
